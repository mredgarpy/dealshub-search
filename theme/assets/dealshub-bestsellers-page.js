/* StyleHub Best Sellers Page v1.0 — Sprint 5
...
(function(){
  ...
  function loadCategory(catId){
    ...
    fetch(API + '/api/amazon-bestsellers?type=BEST_SELLERS&category=' + encodeURIComponent(catId) + '&limit=30', {signal: AbortSignal.timeout(15000)})
      ...
      .catch(function(){
        ...
        contentEl.innerHTML = '<div style="text-align:center;padding:40px;color:#6b7280"><p style="font-size:16px;margin:0 0 8px">Unable to load best sellers</p><p style="font-size:13px;margin:0">Please try again later</p></div>';
      });
  }
  ...
  style.textContent = '@media(max-width:768px){.dh-bs-grid{grid-template-columns:repeat(2,1fr)!important;gap:10px!important}}';
